...

{
	...
	*/
	...
	memcpy(&new;_transitions[i+1], &trie-;>transitions[i],
...

{
    ...
    if(!(*write)(&has;_value, sizeof(has_value), data))
	return 0;
    if(has_value) {
...

{
    ...
    if(!(*write)(&has;_trie, sizeof(has_trie), data))
	return 0;
    if(has_trie) {
...

{
    ...
    if(!(*read)(&has;_value, sizeof(has_value), data))
...

{
	...
	goto _deserialize_transition_error;
    if(!(*read)(&has;_trie, sizeof(has_trie), data))
	goto _deserialize_transition_error;
